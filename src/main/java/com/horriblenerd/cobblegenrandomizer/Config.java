...
public class Config {
    ...
    static {
        ...
        COMMON_BUILDER.comment("List settings", "Syntax: [\"modid:block|weight\"]", "Example: [\"minecraft:stone|2\",\"minecraft:dirt|1\"]", "Forge tags are supported").push(CATEGORY_LISTS);
