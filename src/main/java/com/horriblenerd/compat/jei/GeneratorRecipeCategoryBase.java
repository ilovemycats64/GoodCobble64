...
//        ITextComponent weightString = new StringTextComponent(String.format("%s: %d", I18n.get("cobblegenrandomizer.jei.weight"), recipe.weightedBlock.getWeight()));
//        int y = (1 + this.size) * 18;
//        minecraft.font.draw(ms, weightString, 2, y, 0xFF808080);
//    }
//
//}
